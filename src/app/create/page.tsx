...
export default function Page() {
  ...
  return (
    <div className="p-10  min-h-screen bg-blue-500">
      {styleAlert === "success" && (
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col gap-1 mb-4">
          <label className="text-2xl font-bold" htmlFor="dueDate">DueDate</label>
          <input
            className="border border-gray-900 w-full p-3 rounded-md"
            type="date"
            name="dueDate"
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            disabled={loading}
            className={`bg-white hover:bg-black px-4 py-2 rounded-md transition text-black hover:text-white flex justify-center items-center gap-2 ${
              loading ? "opacity-75" : ""
            }`}
          >
            {loading ? (
